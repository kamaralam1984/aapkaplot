...
const en: Dict = {
  ...
  "hero.eyebrow":    "Verified Real Estate · India",
  "hero.h1.1":       "Plots, Flats &",
  "hero.h1.2":       "Houses",
  "hero.h1.3":       "near you",
  "hero.sub":        "Verified listings with live maps, satellite view & direct owner contact.",
...
const hi: Dict = {
  ...
  "hero.eyebrow":    "वेरिफाइड रियल एस्टेट · भारत",
  "hero.h1.1":       "प्लॉट, फ्लैट और",
  "hero.h1.2":       "मकान",
  "hero.h1.3":       "आपके पास",
  "hero.sub":        "वेरिफाइड लिस्टिंग, लाइव मैप और मालिक से सीधा संपर्क।",
