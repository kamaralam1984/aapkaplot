...
const en: Dict = {
  ...
  "hero.eyebrow":    "AapKaPlot · Real Estate, India",
  "hero.h1.1":       "Jahan Property",
  "hero.h1.2":       "Milti Hai",
  "hero.h1.3":       "Trust Ke Sath",
  "hero.sub":        "Verified plots, flats & houses with live maps, satellite view & direct owner contact.",
  ...
  "footer.tagline":  "India's verified real estate platform.",
  "card.save":       "Save",
...
const hi: Dict = {
  ...
  "hero.eyebrow":    "AapKaPlot · रियल एस्टेट, भारत",
  "hero.h1.1":       "जहाँ प्रॉपर्टी",
  "hero.h1.2":       "मिलती है",
  "hero.h1.3":       "ट्रस्ट के साथ",
  "hero.sub":        "वेरिफाइड प्लॉट, फ्लैट और मकान — लाइव मैप, सैटेलाइट व्यू और मालिक से सीधा संपर्क।",
